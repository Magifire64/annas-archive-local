...
@page.get("/local/torrents")
@page.get("/local/torrents/")
def local_torrents_page():
    from config.settings import LOCAL_MODE
    if not LOCAL_MODE:
        # Redirect to home if not in local mode
        return redirect("/", code=302)
    ...
    return render_template(
        "page/local_torrents.html",
        header_active="local/torrents",
    )
...
def datasets_ia_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_ia.html", header_active="home/datasets/ia", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_duxiu_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_duxiu.html", header_active="home/datasets/duxiu", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_upload_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_upload.html", header_active="home/datasets/upload", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_zlib_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_zlib.html", header_active="home/datasets/zlib", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_scihub_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_scihub.html", header_active="home/datasets/scihub", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_lgrs_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_lgrs.html", header_active="home/datasets/lgrs", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_lgli_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_lgli.html", header_active="home/datasets/lgli", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_ol_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_ol.html", header_active="home/datasets/ol", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_oclc_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_oclc.html", header_active="home/datasets/oclc", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_magzdb_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_magzdb.html", header_active="home/datasets/magzdb", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_nexusstc_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_nexusstc.html", header_active="home/datasets/nexusstc", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_other_metadata_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_other_metadata.html", header_active="home/datasets/other_metadata", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_hathi_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_hathi.html", header_active="home/datasets/hathi", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
def datasets_gbooks_page():
    try:
        stats_data = get_stats_data()
        return render_template("page/datasets_gbooks.html", header_active="home/datasets/gbooks", stats_data=stats_data)
    except Exception as e:
        if 'timed out' in str(e):
            return "Error with datasets page, please try again.", 503
        raise
...
#         if 'timed out' in str(e):
#             return "Error with datasets page, please try again.", 503
#     return render_template("page/datasets_isbn_ranges.html", header_active="home/datasets/isbn_ranges", stats_data=stats_data)
...
def torrents_page():
    torrents_data = all_torrents_data = allthethings.utils.get_torrents_data(mariapersist_engine)
    ...
    with mariapersist_engine.connect() as connection:
        ...
        return render_template(
            ...
            all_torrents_data=all_torrents_data,
            histogram=histogram,
            detailview=False,
        )
...
def torrents_group_page(group):
    ...
    group_found = False
    for top_level in all_torrents_data['small_file_dicts_grouped'].keys():
        if group in all_torrents_data['small_file_dicts_grouped'][top_level]:
            torrents_data = {
                **all_torrents_data,
                'small_file_dicts_grouped': { top_level: { group: all_torrents_data['small_file_dicts_grouped'][top_level][group] } }
            }
            group_found = True
            break
    if not group_found:
    ...
    return render_template(
        "page/torrents.html",
        header_active=f"home/torrents/{group}",
        torrents_data=torrents_data,
        all_torrents_data=all_torrents_data,
        detailview=True,
    )
...
def get_additional_for_aarecord(aarecord):
    ...
    additional['table_row'] = {
        ...
        'filesize': allthethings.utils.format_filesize(aarecord['file_unified_data']['filesize_best']) if aarecord['file_unified_data']['filesize_best'] > 0 else '',
